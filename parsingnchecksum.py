...
payload="B16810110B860B4F0B750B7031A931B431A731B31B00"
payload="B16800110D0B0CDB0B910B7031A131A9319A31AA19D9"
...
if x!=byte2int[21]:
    print("checksum is invalid, the last digit is %s (%s) but xor result is %s" %(byte2int[21],byte[21],x))
else:
